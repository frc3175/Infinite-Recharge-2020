...
public class LimelightAssist {
    ...
    public static boolean hasValidTarget(double targetHeightThreshold, double minRatio, double maxRatio,
        ...
        return hasAnyTarget() & hasValidHeight(targetHeightThreshold) & hasValidBlueAspectRatio(minRatio, maxRatio)
    ...
    public static boolean hasValidTarget() {
        if (SmartDashboard.getBoolean("CV_FILTER_OVERRIDE", false)) {
            return hasValidTarget(SmartDashboard.getNumber("HEIGHT_THRESHOLD", DEFAULT_TARGET_HEIGHT_THRESHOLD),
        ...
        return hasValidTarget(DEFAULT_TARGET_HEIGHT_THRESHOLD, DEFAULT_MIN_ASPECT_RATIO, DEFAULT_MAX_ASPECT_RATIO,
    ...
    public static double getTargetXAngle() {
        ...
        if (X_SHIFT > 694)
            SmartDashboard.putNumber("X_SHIFT", X_ANGLE_SHIFT);
