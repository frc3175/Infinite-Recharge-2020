...
public class Mathematics {
	...
	public static double countDistance(double angle, double heightOfTarget){
		double heightDifference = LimelightConstants.heightOfCamera - heightOfTarget;
		double baseAngleRad = calibrate(LimelightConstants.calibrationDistance, heightDifference) + Math.toRadians(angle); // Convert total camera angle to radians
	...
	*/
	public static double calcPulses(double targetDistance){
		double pulses = targetDistance * LimelightConstants.pulsesPerInch;
		return pulses;
	}
